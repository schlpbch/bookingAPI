...
app.controller('AppCtrl', ['$scope', '$mdSidenav', '$mdDialog', '$http', function($scope, $mdSidenav, $mdDialog, $http) {
  ...
  $scope.sucheVerbindung = function(event) {
    ...
    var url = 'api/verbindungen/?vonUICode=8507000&nachUICode=8508500&datum=2017-01-14&zeit=20%3A22';
  ...
  $scope.holeAngebot = function(event) {
    // ToDo: Load via REST Services
    var url = 'api/angebote/?recContext=RecContext-RC1&vonUICode=8507000&nachUICode=8508500&datum=2017-01-14&zeit=20%3A22&alter=42&ermaessigung=halbtax';
